...
std::ostream & icarus::operator << (std::ostream & os, ICARUSTriggerV2Fragment const & f) {
 
  os << "ICARUSTriggerV2Fragment: " << f.GetDataString();
...
/*
std::ostream & icarus::operator << (std::ostream & os, ICARUSTriggerV2FragmentMetadata const & m) {
  os << "\n\t Name: " << m.getName();
...
bool icarus::ICARUSTriggerV2Fragment::Verify() const {
  return true;
}
